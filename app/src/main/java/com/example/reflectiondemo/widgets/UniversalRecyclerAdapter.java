package com.example.reflectiondemo.widgets;
...
import com.example.reflectiondemo.model.CardLayout;
...
public class UniversalRecyclerAdapter extends RecyclerView.Adapter<UniversalRecyclerAdapter.ViewHolder>
    ...
    public void addAllPaggination(@NonNull final Collection<Card> cards) {

        int position = mCardList.size();

        mCardList.addAll(cards);
        notifyItemRangeInserted(position, mCardList.size());
